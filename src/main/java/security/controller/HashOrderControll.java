...
@WebServlet(name = "HashOrderControll", value = "/HashOrderControll")
public class HashOrderControll extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String orderData;
        try {
            orderData = VerifyDAO.getOrderData(order.getId());
        } catch (Exception e) {
